...
{/*left side content */}
  ...
  <h1 className='text-4xl md:text-6xl font-bold mb-4'>
    Hi, I'm <span className='text-purple'> Dipak Hyalij</span> 
  </h1>
  ...
  <div className='md:w-1/2 flex justify-center '>
   <div className='relative w-64 h-64 md:w-80 md:h-80 '>
    <div className='absolute inset-0 rounded-full bg-gradient-to-r from-purple to-pink  opacity-70' >
      ...
      className='relative rounded-full w-64 h-64 md:w-80 md:h-80 object-cover z-10 animate-float' src={assets.profileImg} alt="profile" />
    </div>
   </div>
  </div>
</div>
