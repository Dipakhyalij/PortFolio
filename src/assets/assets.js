...
export const projects = [
   {
    ...
    description: "A responsive web-based food ordering interface that allows users to browse menus, add items to a cart, and simulate online ordering. The project focuses on clean UI design, reusable components, and smooth navigation to deliver a user-friendly experience. It demonstrates practical frontend development skills for real-world e-commerce applications.",
    image: projectImg1,
    tech: ["React", "javascript", "HTML","CSS", "ContextAPI","React Router"],
  ...
  },
  {
    ...
    image: projectImg2,
    tech: ["ReactJS", "Tailwind CSS", "JavaScript (ES6+)","ContextAPI","React Router"],
  ...
  },
  {
    ...
    image: projectImg3,
    tech: ["ReactJS", "CSS", "JavaScript (ES6+)","API"],
    icons: [FaVuejs, FaFire, FaCloud , FaDatabase],
    demo: "#",
    code: "#",
  },
